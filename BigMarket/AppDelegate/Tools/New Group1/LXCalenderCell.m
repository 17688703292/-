...
-(void)setModel:(LXCalendarDayModel *)model{
    ...
    self.label.attributedText = [NSString changestringArray:@[[NSString stringWithFormat:@"%ld\n",model.day],@"213"] colorArray:@[[UIColor blackColor],[UIColor lightGrayColor]] fontArray:@[@"15.0",@"12.0"]];
