...
@implementation XZXGOODdetail_AdTC
...
- (void)awakeFromNib {
    ...
    self.cycleScrollview = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 0, kScreenWidth,kScreenWidth) imageURLStringsGroup:self.dataSourceUrl];
