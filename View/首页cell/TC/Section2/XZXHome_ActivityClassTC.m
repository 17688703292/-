...
@implementation XZXHome_ActivityClassTC
...
- (void)awakeFromNib {
    ...
    self.CustomeCollectionView.collectionViewLayout = layout;
    
    [self.CustomeCollectionView registerNib:[UINib nibWithNibName:@"XZXHome_ActivityClassCC" bundle:nil] forCellWithReuseIdentifier:@"XZXHome_ActivityClassCCID"];
    [self.CustomeCollectionView registerNib:[UINib nibWithNibName:@"XZXStore_ActityCC" bundle:nil] forCellWithReuseIdentifier:@"XZXStore_ActityCCID"];
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return CGSizeMake((kScreenWidth-30)/num,kScreenWidth/num);
}
